...
if(isset($_GET['view_product'])) {
	...
	if(isset($products[$product_id])) {
		// Display site links
		echo "<p>
			<a href='./shop.php'>INVENTORY</a> &gt; <a href='./shop.php'>" . 
...
// View cart
	...
	// Display site links
	echo "<p>
		<a href='./shop.php'>DropShop</a></p>";
	
	echo "<h3>Your Cart</h3>
	<p>
		<a href='./shop.php?empty_cart=1'>Empty Cart</a>
	</p>";
...
// View all products
	...
	foreach($products as $id => $product) {
		echo "<tr>
			<td style='border-bottom:1px solid #000000;'><a href='./shop.php?view_product=$id'>" . $product['name'] . "</a></td>
